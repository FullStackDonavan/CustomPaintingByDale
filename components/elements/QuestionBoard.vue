      ...
      <div class="flex m-5">
        ...
        <div class="relative w-full">
          <input
            ...
            type="search"
            id="search-dropdown"
            class="block p-2.5 w-full z-20 text-sm text-slate-900 bg-slate-50 rounded-lg border-solid border-2 border-indigo-600 dark:bg-indigo-950 dark:text-gray-300"
