<template>
  <BasicSection>
    <HeroSection
      title="Industrial Strength, Aesthetic Appeal: Concrete Painting"
      description="EXPERIENCE THE MAGIC OF CONCRETE PAINTING"
      url="https://nuxtjs.org"
      image="/img/concrete-painting-banner.jpg"
    />
    <Breadcrumbs
      currentPageTitle="Concrete Painting"
